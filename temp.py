...
def get_conversation_chain():
    ...
    # define the prompt
    prompt_template = """
    you need to prepare a test paper according to query and from the text book which is provided as the context.
    query will contain few parameters listed below and the actual part will be given in the bottom\n
    Level which can be easy, medium, difficult.\n
    No: Number of Questions
    Type: Long answer type, Short answer type, Multiple choice questions, single correct type, fill in the blanks
    chapter: Name of the chapter
    Topics: This can be empty but if provided create the questions only from these topics.
    Make sure to be correct, if anything is not clear just return, "Something went wrong",\n\n
    Context:\n {context}?\n
    Query: \n{question}\n
